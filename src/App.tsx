    ...
    <nav className="fixed top-0 left-0 w-full z-50 glass border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-12">
          ...
          <button onClick={onOpenModal} className="px-6 py-2 border border-gold/50 text-gold text-xs uppercase tracking-[0.2em] hover:bg-gold hover:text-obsidian transition-all duration-500 cursor-pointer">
            Connexion
          </button>
        </div>
      ...
      {isOpen && (
        ...
        >
          ...
          <button onClick={() => { setIsOpen(false); onOpenModal(); }} className="w-full py-4 border border-gold text-gold uppercase tracking-widest cursor-pointer">
            Démarrer
          </button>
        </motion.div>
      )}
...
const Hero = ({ onOpenModal }: { onOpenModal: () => void }) => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex flex-col items-center justify-center pt-32 overflow-hidden px-6">
      {/* Background Elements */}
      ...
      >
        ...
        >
          <button onClick={onOpenModal} className="group relative px-10 py-5 bg-gold text-obsidian font-medium uppercase tracking-widest overflow-hidden transition-all duration-500 hover:pr-14 cursor-pointer">
          ...
          <a href="#architecture" className="px-10 py-5 border border-white/10 hover:border-gold/50 text-alabaster uppercase tracking-widest transition-all duration-500 inline-block cursor-pointer">
    ...
    <section id="manifeste" className="py-32 px-6 bg-obsidian">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            <span className="text-gold uppercase tracking-[0.4em] text-xs mb-6 block">Le Manifeste de l'Ordre</span>
            ...
            <p className="text-xl text-alabaster/60 font-light leading-relaxed mb-12">
              Le foyer moderne est une infrastructure complexe. Sans système, il devient une source de chaos. 
              DOMYLI transforme l'exécution domestique en une routine invisible et parfaite.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-alabaster/40 text-sm">Oublis, stress, gaspillage et désorganisation constante.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-alabaster/40 text-sm">Fluidité, anticipation, économies et sérénité retrouvée.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="architecture" className="py-32 px-6 bg-obsidian">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <span className="text-gold uppercase tracking-[0.4em] text-xs mb-6 block">L'Architecture du Système</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <p className="text-alabaster/50 font-light leading-relaxed">
                {feature.description}
              </p>
            </motion.div>
          ))}
  ...
  return (
    <section id="intelligence" className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="glass rounded-3xl p-12 metallic-border relative z-10">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <span className="text-xs text-alabaster/40 uppercase tracking-widest block mb-2">Contraintes Nutritionnelles</span>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-red-500/10 text-red-400 text-[10px] uppercase border border-red-500/20 rounded-full">Allergie Arachides</span>
                  <span className="px-3 py-1 bg-gold/10 text-gold text-[10px] uppercase border border-gold/20 rounded-full">Sans Gluten</span>
                </div>
              </div>
              <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                <span className="text-xs text-alabaster/40 uppercase tracking-widest block mb-2">Impact Système</span>
                <p className="text-sm text-alabaster/60 italic">"Filtre automatique appliqué sur les stocks et les menus de la semaine."</p>
              </div>
            </div>
          </div>
          {/* Decorative elements */}
        ...
        <div>
          <span className="text-gold uppercase tracking-[0.4em] text-xs mb-6 block">Intelligence Contextuelle</span>
          <h2 className="text-5xl md:text-7xl mb-8 italic">
          ...
          <button onClick={onOpenModal} className="flex items-center gap-4 text-gold uppercase tracking-widest text-sm group cursor-pointer">
...
const Pricing = ({ onOpenModal }: { onOpenModal: () => void }) => {
  const plans = [
    ...
    },
    {
      ...
      price: "9,99€",
      period: "/mois",
      features: ["Multi-membres avancé", "Répartition des efforts", "Vision globale du foyer", "Orchestration plus complète", "Niveau DOMYLI le plus puissant"],
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, idx) => (
            <div 
              key={idx}
              className={`glass rounded-3xl p-12 metallic-border flex flex-col ${plan.highlight ? 'scale-105 gold-glow border-gold/30' : ''}`}
            >
              ...
              <button onClick={onOpenModal} className={`w-full py-4 uppercase tracking-widest text-xs transition-all duration-500 cursor-pointer ${
                plan.highlight 
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2">
            ...
            <p className="text-alabaster/40 max-w-sm font-light leading-relaxed">
              L'infrastructure de gouvernance domestique pour ceux qui exigent l'excellence dans chaque aspect de leur vie.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-alabaster/60">
              <li><a href="#architecture" className="hover:text-gold transition-colors">Fonctionnalités</a></li>
              <li><a href="#intelligence" className="hover:text-gold transition-colors">Sécurité</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-alabaster/60">
              <li><a href="#manifeste" className="hover:text-gold transition-colors">Manifeste</a></li>
              <li><a href="mailto:contact@domyli.com" className="hover:text-gold transition-colors">Contact</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); onOpenModal(); }} className="hover:text-gold transition-colors">Mentions Légales</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:row items-center justify-between pt-12 border-t border-white/5 text-[10px] uppercase tracking-[0.2em] text-alabaster/20">
          ...
          <div className="flex gap-8 mt-4 md:mt-0">
            <a href="#" onClick={(e) => { e.preventDefault(); onOpenModal(); }} className="hover:text-gold transition-colors">Twitter</a>
            <a href="#" onClick={(e) => { e.preventDefault(); onOpenModal(); }} className="hover:text-gold transition-colors">Instagram</a>
            <a href="#" onClick={(e) => { e.preventDefault(); onOpenModal(); }} className="hover:text-gold transition-colors">LinkedIn</a>
          </div>
        </div>
      </div>
    </footer>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <motion.div 
        ...
        className="relative glass p-8 md:p-12 metallic-border max-w-md w-full rounded-2xl shadow-2xl gold-glow"
      >
        <button onClick={onClose} className="absolute top-6 right-6 text-alabaster/50 hover:text-gold transition-colors cursor-pointer">
          <X size={24} />
        </button>
        
        {!submitted ? (
          <>
            <h3 className="text-3xl font-serif italic mb-4">Accès Privilège</h3>
            <p className="text-alabaster/60 font-light text-sm mb-8 leading-relaxed">
              DOMYLI est actuellement en accès restreint. Rejoignez la liste d'attente pour être parmi les premiers à reprendre la souveraineté de votre foyer.
            </p>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-none px-4 py-4 text-sm text-alabaster placeholder:text-alabaster/30 focus:outline-none focus:border-gold/50 transition-colors"
                />
              </div>
              <button type="submit" className="w-full py-4 bg-gold text-obsidian font-medium uppercase tracking-widest text-sm hover:bg-white transition-all duration-500 cursor-pointer">
                Demander un accès
              </button>
            </form>
          </>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-2xl font-serif italic mb-2">Demande enregistrée</h3>
            <p className="text-alabaster/60 font-light text-sm">
      ...
      <main>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[10px] uppercase tracking-widest text-alabaster/40">Propriétaire, Domaine de L'Ermitage</span>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-32 px-6 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <button onClick={() => setIsModalOpen(true)} className="px-12 py-6 bg-gold text-obsidian font-medium uppercase tracking-[0.3em] hover:bg-white transition-all duration-500 hover:scale-105 cursor-pointer">
