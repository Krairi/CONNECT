        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div>
            ...
            <p className="text-xl text-alabaster/60 font-light leading-relaxed mb-12">
              Le foyer moderne est une infrastructure complexe. Sans système, il devient une source
              de chaos. DOMYLI transforme l'exécution domestique en une routine invisible et
              parfaite.
            </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-6 mt-12">
              <div className="aspect-[4/5] glass rounded-2xl metallic-border p-8 flex flex-col justify-end">
                ...
                <span className="text-sm uppercase tracking-widest text-alabaster/60">
                  Souveraineté
                </span>
              </div>
  ...
  const features = [
    {
      ...
      description:
        "Inventaire en temps réel de vos ressources, de l'épicerie fine aux fournitures ménagères.",
    ...
    },
    {
      ...
      description:
        "Suivi du cycle de vie de vos outils et planification des entretiens préventifs.",
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2">
            ...
            <p className="text-alabaster/40 max-w-sm font-light leading-relaxed">
              L'infrastructure de gouvernance domestique pour ceux qui exigent l'excellence dans
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm uppercase tracking-widest text-alabaster/80">
                  Marc-Antoine D.
                </span>
